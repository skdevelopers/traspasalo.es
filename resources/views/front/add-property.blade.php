...
@section('content')
    ...
    <div class="bg-gray-100">
        ...
        <div class="container-fluid mx-auto p-0">
            <div class="grid grid-cols-1 md:grid-cols-6 lg:grid-cols-6 gap-2">
                ...
                <div class="relative lg:col-span-3">
                    <img src="https://via.placeholder.com/715x370" alt="Image 1" class="w-full h-full object-cover">
                </div>

                <!-- Small Images -->
                <div class="relative lg:col-span-3">
                    <img src="https://via.placeholder.com/715x370" alt="Image 3" class="w-full h-full object-cover">
                </div>
                <div class="relative lg:col-span-2">
                    <img src="https://via.placeholder.com/715x370" alt="Image 4" class="w-full h-full object-cover">
                </div>
                <div class="relative lg:col-span-2">
                    <img src="https://via.placeholder.com/715x370" alt="Image 5" class="w-full h-full object-cover">
                </div>
                <!-- More Images Overlay -->
                <div class="relative lg:col-span-2">
                    <img src="https://via.placeholder.com/715x370" alt="Image 6" class="w-full h-full object-cover">
            ...
            <div class="container mx-auto max-w-5xl bg-white  ">
                ...
                <div class="bg-white p-6 flex flex-col md:flex-row md:justify-between items-start md:items-center">
                    <div class="flex-col">
                        ...
                        <div class="flex items-start mb-4">
                            ...
                            <span class="text-gray-700">Francisco Román Alarcón, 1060 W Addison St #13, Chicago, IL
                                60613</span>
                            <span
                                class="text-red-500 ml-1 underline underline-offset-4 md:text-sm text-xs cursor-pointer">Show
                                On Map</span>
                        </div>
                    ...
                    <div class="mt-4 md:mt-0">
                        ...
                        <div>
                            <button
                                class="bg-purple-950 text-white text-xs md:text-sm px-4 py-2 rounded-md flex items-center">
                ...
                <div class="bg-white p-6 rounded-lg">
                    <p class="text-gray-700 mb-4">
                        ...
                        comfortable and relaxing stay for our guests. Whether you are traveling for business or leisure, we
                        have
                        the perfect room to meet your needs.
                    </p>
                    <p class="text-gray-700 mb-4">
                        Our standard rooms are spacious and well-appointed, with comfortable beds, plush pillows, and
                        luxurious
                        linens to ensure a good night's sleep. The rooms also come equipped with modern amenities such as
                        flat-screen TVs, mini-fridges, and high-speed internet access to keep you connected during your
                        stay.
                        Each room has a private bathroom with fresh towels, complimentary toiletries, and hairdryers for
                        your
                        convenience.
                    </p>
                    <p class="text-gray-700 mb-4">
                        The rooms also come equipped with modern amenities such as flat-screen TVs, mini-fridges, and
                        high-speed
        ...
        <section class="py-12 md:px-48">
            <div class="container mx-auto px-4">
                ...
                <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-2">
                    <div class="p-6 bg-white shadow rounded-lg text-center">
                        <img src="path/to/icon1.svg" alt="Accessibility" class="mx-auto mb-4">
                        <p class="text-gray-800">Accessibility</p>
                    </div>
                    <div class="p-6 bg-white shadow rounded-lg text-center">
                        <img src="path/to/icon2.svg" alt="Hot water" class="mx-auto mb-4">
                        <p class="text-gray-800">Hot water</p>
                    </div>
                    <div class="p-6 bg-white shadow rounded-lg text-center">
                        <img src="path/to/icon3.svg" alt="Air-conditioning" class="mx-auto mb-4">
                        <p class="text-gray-800">Air-conditioning</p>
                    </div>
                    <div class="p-6 bg-white shadow rounded-lg text-center">
                        <img src="path/to/icon4.svg" alt="Store" class="mx-auto mb-4">
                        <p class="text-gray-800">Store</p>
                    </div>
                    <div class="p-6 bg-white shadow rounded-lg text-center">
                        <img src="path/to/icon5.svg" alt="Heating" class="mx-auto mb-4">
                        <p class="text-gray-800">Heating</p>
                    </div>
                    <div class="p-6 bg-white shadow rounded-lg text-center">
                        <img src="path/to/icon6.svg" alt="Fully equipped" class="mx-auto mb-4">
                        <p class="text-gray-800">Fully equipped</p>
                    </div>
                    <div class="p-6 bg-white shadow rounded-lg text-center">
                        <img src="path/to/icon7.svg" alt="Kitchen" class="mx-auto mb-4">
                        <p class="text-gray-800">Kitchen</p>
                    </div>
                    <div class="p-6 bg-white shadow rounded-lg text-center">
                        <img src="path/to/icon8.svg" alt="Working" class="mx-auto mb-4">
                        <p class="text-gray-800">Working</p>
                    </div>
                    <div class="p-6 bg-white shadow rounded-lg text-center">
                        <img src="path/to/icon9.svg" alt="Abroad" class="mx-auto mb-4">
                        <p class="text-gray-800">Abroad</p>
                    </div>
                    <div class="p-6 bg-white shadow rounded-lg text-center">
                        <img src="path/to/icon10.svg" alt="Corner" class="mx-auto mb-4">
                        <p class="text-gray-800">Corner</p>
                    </div>
                    <div class="p-6 bg-white shadow rounded-lg text-center">
                        <img src="path/to/icon11.svg" alt="License" class="mx-auto mb-4">
                        <p class="text-gray-800">License</p>
                    </div>
                    <div class="p-6 bg-white shadow rounded-lg text-center">
                        <img src="path/to/icon12.svg" alt="Security door" class="mx-auto mb-4">
            ...
            <div class="container mx-auto max-w-5xl mt-8 p-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                    ...
                    <div class="flex items-center space-x-2">
                        <img src={{ asset('/storage/images/person.png') }} class="h-5 w-2" />
                    ...
                    <div class="flex items-center space-x-4 mt-4 md:mt-0">
                        <img src={{ asset('/storage/images/visa-card.svg') }} alt="Visa" class="w-10 h-6">
                        <img src={{ asset('/storage/images/master-card.svg') }} alt="MasterCard" class="w-10 h-6">
                        <img src={{ asset('/storage/images/amex.svg') }} alt="Amex" class="w-10 h-6">
                        <img src={{ asset('/storage/images/paypal.svg') }} alt="PayPal" class="w-10 h-6">
                    </div>
                </div>
            </div>
        </section>
        ...
        <div class="container mx-auto max-w-6xl mt-8 p-12  bg-white rounded-lg shadow-md">
            ...
            <p class="text-center text-gray-400 text-sm mb-8">Discover the experiences of those who have achieved success
                with us</p>
                    ...
                    <div class="space-y-6">
                        <div>
                            <div class="flex space-x-4">
                                <div class="w-48 ">
                                    <img src={{ asset('/storage/images/gender-pic.svg') }} class="h-36 w-36" />
                                </div>
                                <div class="p-3">
                                    <h4 class="font-semibold text-violet-950">Jessica G. <span
                                            class="text-gray-500 text-sm">April 8, 2024</span></h4>
                                    <p class="text-gray-700 mt-2">
                                        The location of the hotel was perfect for our needs. We were able to easily explore
                                        the city and also had access to plenty of great dining options nearby.
                                    </p>
        ...
        <section class=" text-black py-24 min-h-screen">
            <div class="container flex flex-col justify-center mx-auto">
                ...
                <h2 class="mb-12 text-sm  text-center sm:text-sm">Discover the experiences of those who have achieved
                    success with us</h2>
                            ...
                            <div class="transition-all duration-300 ease-in-out max-h-0 overflow-hidden"
                                ...
                                <div class="pb-5 leading-relaxed">
                                    <div class="space-y-2 leading-relaxed">We prioritize the security of your insurance
                                        information. We use advanced encryption and strict data protection measures to
                                        ensure your data is safe and confidential.</div>
                                </div>
                            </div>
                        </li>
                        <li>
                            ...
                            <div class="transition-all duration-300 ease-in-out max-h-0 overflow-hidden"
                                ...
                                <div class="pb-5 leading-relaxed">
                                    <div class="space-y-2 leading-relaxed">Our insurance plans are customizable. You can
                                        tailor your coverage to meet your specific needs and budget.</div>
                                </div>
                            </div>
                        </li>
                        <li>
                            <button
                                class="relative flex gap-2 items-center w-full py-5 text-base font-semibold text-left border-t md:text-lg border-base-content/10"
                                aria-expanded="false" onclick="toggleFAQ(this)">
                                <span class="flex-1 text-base-content">Is there a waiting period for insurance
                                    claims?</span>
                                <svg width="18" height="18" viewBox="0 0 28 28" fill="none"
                                    xmlns="http://www.w3.org/2000/svg">
                                    <path
                            ...
                            <div class="transition-all duration-300 ease-in-out max-h-0 overflow-hidden"
                                style="transition: max-height 0.3s ease-in-out 0s;">
                                <div class="pb-5 leading-relaxed">
                                    <div class="space-y-2 leading-relaxed">There may be a waiting period for certain
                                        insurance claims, depending on the policy terms and conditions. Please refer to your
                                        policy documents for details.</div>
                                </div>
                            </div>
                        </li>
                        <li>
        ...
        <div class="container mx-auto max-w-full mt-8 p-6 bg-white rounded-lg shadow-md">
            ...
            <p class="text-center text-gray-600 mb-8">Discover the experiences of those who have achieved success with us
            </p>
            ...
            <div class="flex justify-center items-center">
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div class="flex flex-col md:flex-row rounded-lg border-2 border-gray-100 max-w-sm mx-auto">
                        <img src="{{ asset('/storage/images/hotel-Newyork.svg') }}" alt="Hotel Image"
