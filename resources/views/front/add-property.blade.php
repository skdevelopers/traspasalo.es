    ...
    <div class="flex-col">
        ...
        <div class="flex items-start mb-4">
            <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 8 8" class="mr-2">
                <path fill="#270B79" d="M4 0C2.34 0 1 1.34 1 3c0 2 3 5 3 5s3-3 3-5c0-1.66-1.34-3-3-3m0 1a2 2 0 0 1 2 2c0 1.11-.89 2-2 2a2 2 0 1 1 0-4" />
            </svg>
            <span class="text-gray-700">Francisco Román Alarcón, 1060 W Addison St #13, Chicago, IL 60613</span>
            <span class="text-red-500 ml-1 underline underline-offset-4 md:text-sm text-xs cursor-pointer">Show On Map</span>
        </div>
        ...
        <div class="flex space-x-4 mb-4">
            ...
            <button class="rounded-full border-2 border-gray-300 p-2">
                <svg class="w-6 h-6 text-gray-500 fill-current" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
                    <path fill="#270B79" d="M18 16.08c-.76 0-1.44.3-1.96.77L8.91 12.7c.05-.23.09-.46.09-.7s-.03-.47-.09-.7l7.05-4.11c.54.5 1.25.81 2.03.81 1.66 0 3-1.34 3-3s-1.34-3-3-3-3 1.34-3 3c0 .24.04.47.09.7L7.96 9.81c-.54-.5-1.25-.81-2.03-.81-1.66 0-3 1.34-3 3s1.34 3 3 3c.78 0 1.49-.31 2.03-.81l7.13 4.17c-.05.21-.08.44-.08.67 0 1.66 1.34 3 3 3s3-1.34 3-3-1.34-3-3-3z" />
                </svg>
            </button>
        </div>
        <div>
            <button class="bg-purple-950 text-white text-xs md:text-sm px-4 py-2 rounded-md flex items-center">
                <svg class="w-4 md:h-4 h-3 fill-current mr-1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 19 18" aria-hidden="true">
...
<p class="text-center text-gray-400 text-sm mb-8">Discover the experiences of those who have achieved success with us</p>
                ...
                <div class="flex space-x-4">
                    ...
                    <div class="p-3">
                        ...
                        <p class="text-gray-700 mt-2">
                            The location of the hotel was perfect for our needs. We were able to easily explore the city and also had access to plenty of great dining options nearby.
                        </p>
            ...
            <div class="flex flex-col justify-between px-4">
                <div>
                    ...
                    <div class="flex items-center mt-2">
                        <svg xmlns="http://www.w3.org/2000/svg" class="text-yellow-500 h-5 w-5 mr-1" viewBox="0 0 20 20" fill="currentColor">
                            <path d="M9.049 2.927C9.27 2.373 9.73 2 10.3 2c.571 0 1.03.373 1.251.927l1.45 3.22 3.51.511c.558.081.779.756.376 1.145l-2.545 2.48.601 3.5c.093.544-.474.955-.95.7L10 13.348l-3.147 1.653c-.476.255-1.042-.156-.95-.7l.601-3.5-2.545-2.48c-.403-.389-.182-1.064.376-1.145l3.51-.511 1.45-3.22z" />
                        </svg>
