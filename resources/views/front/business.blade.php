...
@section('content')
    ...
    <div class="container-fluid mx-auto p-0">
        <div class="grid grid-cols-1 md:grid-cols-6 lg:grid-cols-6 gap-2">
            ...
            <div class="relative lg:col-span-2">
                <img src={{ asset('/front/assets/images/home-house-exterior-design-showing-tropical-pool-villa.jpg') }}
                    alt="Image 5" class="w-full h-full object-cover">
            </div>
            <!-- More Images Overlay -->
            <div class="relative lg:col-span-2">
                <img src={{ asset('/front/assets/images/home-house-exterior-design-showing-tropical.jpg') }} alt="Image 6"
    ...
    <section class="py-12 md:px-48">
        <div class="container mx-auto px-4">
            ...
            <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-2">
                ...
                <div class="p-6 bg-white shadow rounded-lg text-center">
                    <img src="{{ asset('front/assets/images/air-conditioning.svg') }}" alt="Air-conditioning"
                        class="mx-auto mb-4">
