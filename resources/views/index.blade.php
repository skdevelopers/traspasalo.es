            ...
            <div class="grid xl:grid-cols-3 md:grid-cols-2 gap-6 mb-6">
                <div class="card">
                    <div class="p-6 flex flex-col items-center justify-center text-center">
                        <div>
                            <h4 class="text-lg font-medium text-gray-600 dark:text-gray-400 mb-1">Businesses</h4>
                            <p class="text-3xl font-bold text-gray-800 dark:text-gray-100">{{ $totalBusinesses }}</p>
                        </div>
                        <div class="mt-4">
                            <a href="javascript:void(0);">
                                <img src="{{ asset('images/users/business.png') }}" class="rounded-full h-12 w-12 border-2 border-gray-300 dark:border-gray-700" alt="business">
                            </a>
                        </div>
                    </div>
                </div>
                ...
                <div class="card">
                    <div class="p-6 flex flex-col items-center justify-center text-center">
                        <div>
                            <h4 class="text-lg font-medium text-gray-600 dark:text-gray-400 mb-1">Users</h4>
                            <p class="text-3xl font-bold text-gray-800 dark:text-gray-100">{{ $totalUsers }}</p>
                        </div>
                        <div class="mt-4">
                            <a href="javascript:void(0);">
                                <img src="{{ asset('/images/users/users.png') }}" class="rounded-full h-12 w-12 border-2 border-gray-300 dark:border-gray-700" alt="users">
                            </a>
                        </div>
                    </div>
                </div>
                ...
                <div class="card">
                    <div class="p-6 flex flex-col items-center justify-center text-center">
                        <div>
                            <h4 class="text-lg font-medium text-gray-600 dark:text-gray-400 mb-1">Clients</h4>
                            <p class="text-3xl font-bold text-gray-800 dark:text-gray-100">{{ $totalCustomers }}</p>
                        </div>
                        <div class="mt-4">
                            <a href="javascript:void(0);">
                                <img src="{{ asset('/images/users/clients.png') }}" class="rounded-full h-12 w-12 border-2 border-gray-300 dark:border-gray-700" alt="clients">
                            </a>
                        </div>
                    </div>
                </div>
