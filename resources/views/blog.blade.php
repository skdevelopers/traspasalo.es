            ...
            <div class="slider relative  overflow-hidden">
              <div class="slider-track flex sm:grid-cols-1">
                <div class="slider-item p-2">
                  <div class="bg-white rounded-lg shadow-lg overflow-hidden">
                    <img src={{ asset('assets/images/water-house.svg')}} alt="Image 1" class="w-full h-48 object-cover">
                    <div class="p-4">
                ...
                <div class="slider-item p-2">
                    <div class="bg-white rounded-lg shadow-lg overflow-hidden">
                      <img src={{ asset('assets/images/park-house.svg')}} class="w-full h-48 object-cover">
                      <div class="p-4">
                        <span class="text-sm text-orange-500">Real Estate</span><span> | January 19, 2024</span>
                      <h3 class="text-md font-semibold">How to build a scalable customer service team structure</h3>
                    </div>
                ...
                <div class="slider-item p-2">
                  <div class="bg-white rounded-lg shadow-lg overflow-hidden">
                    <img src={{ asset('assets/images/farm-house.svg')}} alt="Image 2" class="w-full h-48 object-cover">
                    <div class="p-4">
                        <span class="text-sm text-orange-500">Real Estate</span><span> | January 19, 2024</span>
                      <h3 class="text-md font-semibold">How to build a scalable customer service team structure</h3>
                    </div>
