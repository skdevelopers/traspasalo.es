            ...
            <div class="bg-white rounded-xl p-6 w-full max-w-xs sm:max-w-sm md:max-w-sm lg:max-w-sm xl:max-w-sm shadow-lg">
                ...
                <div>
                    ...
                    <form class="space-y-4" method="POST" action="{{ route('login') }}">
                        ...
                        <div>
                            ...
                            <div class="text-right mt-2">
                                <a href="{{ route('auth.recoverpw') }}" class="text-sm font-semibold text-black hover:text-indigo-500">Forgot password?</a>
                            </div>
                        </div>
                        <div>
                    ...
                    <p class="mt-6 text-center text-sm text-gray-600">
                        ...
                        <a href="{{ route('register.step1') }}" class="font-semibold text-black hover:text-indigo-500 underline">Create Account</a>
                    </p>
                </div>
            </div>
        </div>
