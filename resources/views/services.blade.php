    ...
    <form>
        ...
        <div class="mb-4">
            ...
            <div class="w-full h-64 bg-gray-200 rounded-md overflow-hidden">
                ...
                <img src={{asset('/assets/images/passenger-plane-airport-near-terminal-stands-concept-flight-airport-vacation.svg')}} alt="Map placeholder" class="w-auto h-full  object-cover">
            </div>
        </div>
